...
<script>
import stledgerview from './stledgerview.vue'
import stdocregisterview from './stdocregisterview.vue'
import stmislipsiew from './stmislipsview.vue'
import ststockmasterview from './ststockmasterview.vue'
export default {
    name:"mainstore",
    components:{ stledgerview,stdocregisterview,stmislipsiew,ststockmasterview},
