                      ...
                      >
                        ...
                        <template   v-slot:detailrow="ps" >
                            ...
                            <component
                                    ...
                                    :is="ktable_old[workordernos.index][ps.index]"
                                    vbind="defineapiorderlist(slotprops.item,slotprops.index)"

                                 :apiurl="api_root+'/ppc/ajax/orderlist?dno='+ps.item.dno+'&parentsec='+ps.item.parentsec"
                                 :groupfields="false"
                                 :use-detail-row="true"
                            ...
                            >
                               ...
                               <template v-slot:detailrow="old">
                               <table>
                               <tr>
                               <td colspan="2" width="100%">
                               <component
                                        :ref="'ktable'+old.item.dno+old.item.drwgnoa"
                                       :key="'op'+'ol'+workordernos.index+'ps'+ps.index+'old'+old.index"
                                       :is="ktable_op[workordernos.index][ps.index][old.index]"
                                       
                                        :apiurl="api_root+'/ppc/ajax/operations?dno='+old.item.dno+'&drwgno='+old.item.drwgnoa+'&parentsec='+old.item.parentsec"
                                        rowcolor="white"
                                        :headervisible="false"
                                        :useserialnos="false"
                                   ...
                                   <td class="tddetailrow" width="50%">
                                        <component
                                          :key="'running'+'ol'+workordernos.index+'ps'+ps.index+'old'+old.index"
                                          :is="ktable_run[workordernos.index][ps.index][old.index]"
                                        :apiurl="api_root+'/ppc/ajax/smallpartsrunning?workorderno='+old.item.workorderno+'&drwgno='+old.item.drwgnoa"
                                        rowcolor="lightgreen"
                                        :headervisible="false"
                                        :useserialnos="false"
                                   ...
                                   <td class="tddetailrow" width="50%">
                                       <component
                                          :key="'stdparts'+'ol'+workordernos.index+'ps'+ps.index+'old'+old.index"
                                          :is="ktable_fps[workordernos.index][ps.index][old.index]"
                                        :apiurl="api_root+'/ppc/ajax/homtransac?won='+old.item.workorderno+'&drwgno='+old.item.drwgnoa"
                                        rowcolor="lightblue"
                                        :headervisible="false"
                                        :useserialnos="false"
            ...
            methods:{
                ...
                rowclicked1:function(item,psindex){
                    ...
                    // console.log(psindex);
                     ...
                     this.ktable_old[this.ol_currentindex][this.ps_currentindex]='';
                     this.ktable_op[this.ol_currentindex][psindex]=[];
                     this.ktable_run[this.ol_currentindex][psindex]=[];
                     this.ktable_fps[this.ol_currentindex][psindex]=[];
                     this.ktable_old[this.ol_currentindex][psindex]=ktable;
                ...
                rowclicked2:function(item,oldindex){
                    //console.log(item);
                     ...
                     this.ktable_op[this.ol_currentindex][this.ps_currentindex][this.old_currentindex]='';
                     this.ktable_run[this.ol_currentindex][this.ps_currentindex][this.old_currentindex]='';
                    this.ktable_fps[this.ol_currentindex][this.ps_currentindex][this.old_currentindex]='';
                    
                     this.ktable_op[this.ol_currentindex][this.ps_currentindex][oldindex]=ktable;
                     this.ktable_run[this.ol_currentindex][this.ps_currentindex][oldindex]=ktable;
                     this.ktable_fps[this.ol_currentindex][this.ps_currentindex][oldindex]=ktable;
                     this.old_currentindex=oldindex
                     console.log('op3= ');
                        console.log(this.ktable_op)
